...
# ~ This allows the code to run iteratively for a list of parameters and save each run into a specific folder 
	...
	filename = "/home/jose/Documents/moist_QG_channel-main/run_E_{}/N".format(str(val_Er)) + str(N2) + "_" + str(L) + "_" + str(C) + "_" + str(Er)  + "_" + str(U_1) + ".nc"
	print(filename)
	#res_filename = "../../data/moist_qg/N" + str(N2) + "_" + str(L) + "_" + str(C) + "_" + str(Er)  + "_" + str(U_1) + "_res"
	res_filename = "/home/jose/Documents/moist_QG_channel-main/run_E_{}/N".format(str(val_Er)) + str(N2) + "_" + str(L) + "_" + str(C) + "_" + str(Er)  + "_" + str(U_1) + "_res"
...
def main():
	Er_list = [0.01,0.02,0.05,0.1,0.2]
	i = 0
	for i in Er_list:
		print("Evaporation rate for this model run: %0.2f" %i)
		model_run(i)
